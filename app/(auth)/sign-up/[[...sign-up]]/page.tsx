              ...
              <SignUp.Step name="start">
                <Card className="w-full sm:w-96">
                  <CardHeader>
                    ...
                    <CardDescription>Olá, preencha os dados para continuar.</CardDescription>
                  </CardHeader>
              ...
              <SignUp.Step name="verifications">
                ...
                <SignUp.Strategy name="code">
                  <Card className="w-full sm:w-96">
                    <CardHeader>
                      ...
                      <CardDescription>Utilize o código de verificação enviado para seu email</CardDescription>
                    </CardHeader>
                    <CardContent className="grid gap-y-4">
                ...
                <SignUp.Strategy name="email_link">
                  <Card className="w-full sm:w-96">
                    <CardHeader>
                      <CardTitle>Verifique seu email</CardTitle>
                      <CardDescription>Utilize o link mágico enviado para seu email.</CardDescription>
                    </CardHeader>
                    <CardContent className="grid gap-y-4">
                      <Clerk.Field name="code">
                        <div className="grid items-center justify-center gap-y-2">

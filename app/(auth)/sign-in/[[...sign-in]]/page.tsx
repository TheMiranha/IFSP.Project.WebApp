          ...
          {(isGlobalLoading) => (
            <>
              ...
              <SignIn.Step name="choose-strategy">
                <Card className="w-full sm:w-96">
                  <CardHeader>
                    <CardTitle>Utilizar outro método</CardTitle>
                    <CardDescription>Tendo problemas? Você pode usar qualquer um desses métodos para entrar.</CardDescription>
                  </CardHeader>
                  <CardContent className="grid gap-y-4">
                ...
                <SignIn.Strategy name="password">
                  <Card className="w-full sm:w-96">
                    <CardHeader>
                      ...
                      <CardDescription>Insira o código de verificação enviado para seu email.</CardDescription>
                ...
                <SignIn.Strategy name="email_code">
                  <Card className="w-full sm:w-96">
                    <CardHeader>
                      ...
                      <CardDescription>Insira o código de verificação enviado para seu email.</CardDescription>
                      <p className="text-sm text-muted-foreground">
                        Olá novamente <SignIn.SafeIdentifier />
                      </p>
                    </CardHeader>
                    <CardContent className="grid gap-y-4">
